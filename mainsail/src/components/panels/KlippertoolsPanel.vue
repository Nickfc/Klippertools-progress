    ...
    <panel
        ...
        <v-card-text class="klippertools-core">
            <div class="klippertools-core__identity">
                ...
                <v-chip x-small outlined color="success">{{ enabledToolCount }} / {{ toolStatuses.length }}</v-chip>
            </div>
        ...
        <v-dialog v-model="showUpdateDialog" max-width="520">
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-progress-linear v-if="updateStatus.updating" indeterminate color="primary" class="mt-4" />
                    <v-alert
...
export default class KlippertoolsPanel extends Mixins(BaseMixin) {
    ...
    get available(): boolean {
        return Boolean(
            ...
            this.$store.state.printer?.thermal_soak ||
            this.$store.state.printer?.calibration_center
        )
    }
    ...
    get toolStatuses(): ToolStatus[] {
        return [
            ...
            },
            {
                ...
                available: Boolean(this.$store.state.printer?.thermal_soak?.ready),
            },
            {
                key: 'motion',
            ...
            },
            {
                ...
                label: 'Calibration',
                icon: mdiTuneVariant,
                available: Boolean(this.$store.state.printer?.calibration_center?.ready),
            },
            {
                key: 'registry',
                label: 'Tool registry',
